...
/**
 * Email/password signup. When the Supabase project has email confirmation on,
 * the action returns a notice instead of a session — that path is rendered
 * here in place of the form.
 */
